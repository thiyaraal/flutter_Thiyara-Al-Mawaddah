...
class FieldText extends StatefulWidget {
  final String name;
  const FieldText({Key? key, required this.name}) : super(key: key);
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: const Text(
                'A dialog is a type of modal windowthat appears in front of app content to provide critical information, or prompt for a decision to made.',
                style: TextStyle(
                  fontSize: 14,
                  color: Colors.grey,
                ),
